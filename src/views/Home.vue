 ...
 * @LastEditors: Cxy
 * @LastEditTime: 2021-12-20 16:22:43
...
<template>
  <div class='home_Wrap'>
    ...
    <div class='home_Content_Wrap'>
      ...
      <div class='label_Weather_Title home_Article_Title'>
      ...
      <div class='home_Article'>
        <div class='home_Article_Content'>
          <div class='home_Article_Content_Left'>
            ...
            <div
              ...
              class='home_Article_Content_Left_Bg'>
              <div class='home_Article_Content_Left_Bg_Show'>
              ...
              <div class='home_Article_Content_Left_Bg_Hide' v-html='active_Data.html_Article'/>
            </div>
          </div>
          <div class='home_Article_Content_Center'>
            <div
              v-for='c in article_Like_New_Data'
              :key='c._id'
              class='home_Article_Content_Center_Item'
              :class="
                c._id === active_Id
                  ? 'home_Article_Content_Center_Item_Sel'
                  : ''
              "
              ...
              <div
                ...
                class='home_Article_Content_Center_Item_Bg'/>
              <div class='home_Article_Content_Center_Item_Con'>
          ...
          <div class='home_Article_Content_Right'>
            <h3>初衷</h3>
            <p>网站旨在供小伙伴们可以通过此平台发布交流学习的平台</p>
            <div class='home_Article_Content_Right_Bg'/>
            <h3>功能</h3>
      ...
      .home_Article_Content {
        ...
        .home_Article_Content_Left {
          ...
          .home_Article_Content_Left_Bg {
            ...
            border-radius: 5px;
            position: relative;
            .home_Article_Content_Left_Bg_Show {
              transition: 0.5s all;
              position: absolute;
              width: 84%;
              height: 84%;
            ...
            .home_Article_Content_Left_Bg_Hide {
              position: absolute;
              transition: 0.5s all;
              width: 84%;
              height: 84%;
        ...
        .home_Article_Content_Center {
          margin: 0 3% 0 2%;
          width: 55%;
          display: flex;
          flex-direction: column;
          justify-content: space-between;
          .home_Article_Content_Center_Item {
            height: 26%;
            padding: 2%;
            border-radius: 5px;
            display: flex;
            ...
            cursor: pointer;
            .home_Article_Content_Center_Item_Bg {
              border-radius: 5px;
              height: 100%;
              width: 35%;
              background-position: center;
            ...
            .home_Article_Content_Center_Item_Con {
              width: 60%;
              margin-left: 5%;
              display: flex;
              flex-direction: column;
